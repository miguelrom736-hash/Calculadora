...
<style>
    ...
    div[data-testid="stSelectbox"] div[data-baseweb="select"] > div, /* Selectores antiguos (por si acaso) */
    div[data-testid="stDateInput"] div[data-baseweb="input"] /* Campos de Fecha */ {
        border-color: #000000 !important; /* Negro puro */
        border-style: solid !important;
        border-width: 1px !important;
        border-radius: 8px !important;
    }

    /* 3. Efecto al hacer clic (Foco) para saber dónde estás escribiendo */
...
def reorder_ids(table_name):
    """ Reorganiza las IDs de la tabla para eliminar huecos tras eliminar un registro """
    conn = sqlite3.connect(DB_NAME)
    cursor = conn.cursor()
